...
writer = SummaryWriter(comment='_LSTM')
...
class LSTM_Model(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, fc_units, bidirectional=False):
        ...
        self.fc_input_size = hidden_size * 2 if bidirectional else hidden_size
        self.fc_layers = nn.ModuleList()
        prev_units = self.fc_input_size
